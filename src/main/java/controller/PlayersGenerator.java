    ...
    public static Enemy newEnemy( Hero hero )
    {
        ...
        else if ( enemy == 3 )
        {
            if ( artifact.equals( "FIGHT" ) )
            {
                ...
                hitpoints = 100;
                xpoints = 0;
                return ( new spooky( level, attack, defense, hitpoints, xpoints, weapon ) );
            }
            else if ( artifact.equals( "ARMOR" ) )
            {
                Armor armor = new Armor( "Armor" );
                ...
                hitpoints = 100;
                xpoints = 0;
                return ( new spooky( level, attack, defense, hitpoints, xpoints, armor ) );
            }
            else if ( artifact.equals( "HELM" ) )
            {
                Helm helm = new Helm( "Helm" );
                ...
                hitpoints = 100;
                xpoints = 0;
                return ( new spooky( level, attack, defense, hitpoints, xpoints, helm ) );
            }
        }
        return ( null );
    }
